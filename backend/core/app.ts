...
router.route({
        ...
        routers: [
            ...
            {path: 'statistics'},
            {path: 'statistics/html/overview', route: 'statistics/overview'},
            {path: 'statistics/html/season', route: 'statistics/season'},
            {path: 'statistics/html/timeline', route: 'statistics/timeline'},
